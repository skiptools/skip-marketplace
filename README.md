...
In-app purchases, subscriptions, app reviews, and update prompts for [Skip](https://skip.dev) apps on both iOS and Android.
...
> [!TIP]
> SkipMarketplace works best for non-consumable one-time-product entitlements. For subscriptions with server-side management, consider using [RevenueCat](https://www.revenuecat.com/) via the [skip-revenue](https://github.com/skiptools/skip-revenue) library.
